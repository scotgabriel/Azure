...
# original can be found here: https://github.com/KGHague/PowerShell (2021-10-19 @0932)
...
$results | Sort-Object LastName,FirstName | Select-Object FirstName,LastName,UPN,"MFA Enabled",DefaultMethod,Licensed,AssignedLicense | Export-Excel -Path "$ExportPath\$CompanyName - $(Get-Date -Format yyyyMMdd-HHmmss).xlsx" -AutoSize -ConditionalText $Text1 -Title "$CompanyName" -TableStyle Medium9 -Style $style
